...
<div class="login">
    ...
    <form class="layui-form login-container " action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" name="twopass" lay-verify="required" placeholder="请输入" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function () {
        ...
        form.on('submit(demo1)', function (data) {
            if (data.field.pass != data.field.twopass) {
                layer.alert("两次密码不一致");
            } else {
                $.ajax({
                    type: 'POST',
                    url: 'user/register',
                    data: {account: data.field.account, password: data.field.pass,role:data.field.role},
